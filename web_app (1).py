...
# Daftar semua indikator yang bisa dipilih/dicentang user, plus keterangan
# singkat buat ditampilkan di sidebar. Key-nya harus sama persis dengan
# key di dalam compute_all_indicators() -> "indicators" dict.
AVAILABLE_INDICATORS = {
    ...
    "bsjp": "Screener BSJP (Beli Sore Jual Pagi)",
    "bpjs": "Screener BPJS (Beli Pagi Jual Sore)",
}
