...
def check_broker_accumulation(symbol: str, date: str = None) -> dict:
    ...
    if not results:
        return {"triggered": False, "value": "Data broker summary tidak tersedia (cek API key/kuota GoAPI)"}
    ...
    if not broker_net:
        return {"triggered": False, "value": "Data broker summary kosong buat tanggal ini"}
